...
const AppStore = {
    ...
    smes: JSON.parse(localStorage.getItem('kc_smes') || 'null') || [
        ...
        { id:'sme_7', name:'Lobatse Leather Works', sector:'Manufacturing', owner:'Onalenna Mogwe', email:'ona@lobatseleather.co.bw', registration_no:'BW-2019-01567', tax_id:'TIN-66234', status:'approved', risk_level:'low', credit_score:74, revenue:5100000, expenses:3700000, net_income:1400000, total_assets:9500000, total_liabilities:3200000, current_assets:3200000, current_liabilities:1400000, tax_compliant:true, license_valid:true, license_expiry:'2027-06-15', liquidity_ratio:2.29, leverage_ratio:0.337, profitability_ratio:0.275, cash_flow_projection:[410000,430000,420000,450000,470000,480000], repayment_history:[100,100,100,100,95,100], created_at:'2024-07-20', eligible:true, pool_id:'pool_1', funded_amount:600000, employees:38 },
        { id:'sme_8', name:'Nata Solar Solutions', sector:'Technology', owner:'Tumisang Kgosi', email:'tumi@natasolar.co.bw', registration_no:'BW-2023-00345', tax_id:'TIN-88123', status:'approved', risk_level:'low', credit_score:85, revenue:7800000, expenses:5200000, net_income:2600000, total_assets:15000000, total_liabilities:4800000, current_assets:4200000, current_liabilities:1900000, tax_compliant:true, license_valid:true, license_expiry:'2027-09-30', liquidity_ratio:2.21, leverage_ratio:0.32, profitability_ratio:0.333, cash_flow_projection:[520000,560000,540000,580000,600000,620000], repayment_history:[100,100,100,100,100,100], created_at:'2024-05-10', eligible:true, pool_id:'pool_1', funded_amount:900000, employees:52 },
        { id:'sme_9', name:'Palapye Construction Co', sector:'Construction', owner:'Letsile Tebogo', email:'letsile@palcon.co.bw', registration_no:'BW-2021-00456', tax_id:'TIN-77345', status:'approved', risk_level:'medium', credit_score:58, revenue:4200000, expenses:3500000, net_income:700000, total_assets:7200000, total_liabilities:4100000, current_assets:2100000, current_liabilities:1600000, tax_compliant:true, license_valid:true, license_expiry:'2026-08-15', liquidity_ratio:1.31, leverage_ratio:0.569, profitability_ratio:0.167, cash_flow_projection:[200000,180000,220000,240000,210000,230000], repayment_history:[100,95,90,95,100,90], created_at:'2024-09-01', eligible:true, pool_id:'pool_2', funded_amount:350000, employees:30 },
        { id:'sme_10', name:'Jwaneng Diamond Cutters', sector:'Mining', owner:'Masego Olebile', email:'masego@jwcutters.co.bw', registration_no:'BW-2020-00912', tax_id:'TIN-55678', status:'pending', risk_level:'low', credit_score:71, revenue:8500000, expenses:6200000, net_income:2300000, total_assets:18000000, total_liabilities:6500000, current_assets:5000000, current_liabilities:2200000, tax_compliant:true, license_valid:true, license_expiry:'2027-04-30', liquidity_ratio:2.27, leverage_ratio:0.361, profitability_ratio:0.271, cash_flow_projection:[600000,650000,620000,680000,700000,720000], repayment_history:[100,100,100,100,100,100], created_at:'2025-02-15', eligible:true, pool_id:null, funded_amount:0, employees:65 },
    ],

    // ---- POOLS (FR-9) ----
    pools: JSON.parse(localStorage.getItem('kc_pools') || 'null') || [
        { id:'pool_1', name:'Green Growth Fund I', risk_level:'low', sme_ids:['sme_1','sme_2','sme_7','sme_8'], total_exposure:2750000, avg_credit_score:80, status:'active', created_at:'2024-11-01', coupon_rate:7.5, maturity_months:36 },
        { id:'pool_2', name:'Diversified SME Fund II', risk_level:'medium', sme_ids:['sme_3','sme_4','sme_9'], total_exposure:900000, avg_credit_score:54, status:'active', created_at:'2025-01-15', coupon_rate:10.2, maturity_months:24 },
    ],
    ...
    investors: JSON.parse(localStorage.getItem('kc_investors') || 'null') || [
        ...
        { id:'inv_4', name:'Debswana Pension Trust', email:'pension@debswana.co.bw', type:'pension_fund', mandate:'Balanced', risk_appetite:'low', total_invested:450000, created_at:'2024-11-20' },
        { id:'inv_5', name:'Botswana Insurance Holdings', email:'invest@bihl.co.bw', type:'insurance', mandate:'Conservative', risk_appetite:'low', total_invested:320000, created_at:'2025-01-18' },
    ],
    ...
    subscriptions: JSON.parse(localStorage.getItem('kc_subscriptions') || 'null') || [
        ...
        { id:'sub_5', investor_id:'inv_4', tranche_id:'tr_1', amount:450000, status:'confirmed', date:'2025-01-25' },
        { id:'sub_6', investor_id:'inv_5', tranche_id:'tr_4', amount:200000, status:'confirmed', date:'2025-02-05' },
        { id:'sub_7', investor_id:'inv_4', tranche_id:'tr_5', amount:120000, status:'confirmed', date:'2025-02-12' },
    ],
    ...
    payments: JSON.parse(localStorage.getItem('kc_payments') || 'null') || [
        ...
        { id:'pay_10', type:'disbursement', sme_id:'sme_7', amount:600000, date:'2024-12-15', status:'completed', reference:'DISB-2024-003' },
        { id:'pay_11', type:'disbursement', sme_id:'sme_8', amount:900000, date:'2024-12-20', status:'completed', reference:'DISB-2024-004' },
        { id:'pay_12', type:'disbursement', sme_id:'sme_9', amount:350000, date:'2025-01-10', status:'completed', reference:'DISB-2025-002' },
        { id:'pay_13', type:'repayment', sme_id:'sme_7', amount:52000, date:'2025-01-20', status:'completed', reference:'REP-2025-005', scheduled:52000 },
        { id:'pay_14', type:'repayment', sme_id:'sme_8', amount:75000, date:'2025-01-20', status:'completed', reference:'REP-2025-006', scheduled:75000 },
        { id:'pay_15', type:'repayment', sme_id:'sme_7', amount:52000, date:'2025-02-20', status:'completed', reference:'REP-2025-007', scheduled:52000 },
        { id:'pay_16', type:'repayment', sme_id:'sme_8', amount:75000, date:'2025-02-20', status:'completed', reference:'REP-2025-008', scheduled:75000 },
        { id:'pay_17', type:'repayment', sme_id:'sme_3', amount:28000, date:'2025-02-25', status:'completed', reference:'REP-2025-009', scheduled:28000 },
        { id:'pay_18', type:'repayment', sme_id:'sme_9', amount:32000, date:'2025-02-25', status:'late', reference:'REP-2025-010', scheduled:32000, days_late:3 },
        { id:'pay_19', type:'investor_payout', investor_id:'inv_4', amount:2440, date:'2025-02-28', status:'completed', reference:'PAY-2025-003', tranche_id:'tr_1' },
        { id:'pay_20', type:'investor_payout', investor_id:'inv_5', amount:1330, date:'2025-02-28', status:'completed', reference:'PAY-2025-004', tranche_id:'tr_4' },
        { id:'pay_21', type:'investor_payout', investor_id:'inv_1', amount:3680, date:'2025-02-28', status:'completed', reference:'PAY-2025-005', tranche_id:'tr_1' },
        { id:'pay_22', type:'investor_payout', investor_id:'inv_2', amount:1875, date:'2025-02-28', status:'completed', reference:'PAY-2025-006', tranche_id:'tr_2' },
    ],
    ...
    notifications: [
        ...
        { id:'n2', title:'Late Payment Alert', desc:'Gaborone Fresh Foods - 5 days overdue (REP-2025-004)', type:'warning', read:false, time:'2025-02-20T14:30:00Z' },
        ...
        { id:'n4', title:'License Expiry Warning', desc:'Kasane Logistics license expires in 30 days', type:'warning', read:false, time:'2025-02-01T09:00:00Z' },
        ...
        { id:'n6', title:'New SME Application', desc:'Jwaneng Diamond Cutters submitted application - pending review', type:'info', read:false, time:'2025-02-15T11:00:00Z' },
        { id:'n7', title:'Investor Payout Completed', desc:'February payouts processed - P9,325 distributed to 4 investors', type:'success', read:false, time:'2025-02-28T06:00:00Z' },
        { id:'n8', title:'Pool Performance Update', desc:'Green Growth Fund I - 91% subscribed, above target', type:'success', read:true, time:'2025-02-25T09:00:00Z' },
        { id:'n9', title:'Late Payment Alert', desc:'Palapye Construction Co - 3 days overdue (REP-2025-010)', type:'warning', read:false, time:'2025-02-28T07:00:00Z' },
        { id:'n10', title:'Debswana Pension Trust Subscribed', desc:'New investment of P450,000 in Senior Tranche', type:'success', read:true, time:'2025-01-25T15:00:00Z' },
    ],
