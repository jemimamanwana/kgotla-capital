...
// Auth guard - auto-login as admin if no session (demo mode)
(function() {
    if (!AppStore.currentUser) {
        const demoUser = { id: 'demo_admin', email: 'admin@kgotla.co.bw', role: 'admin', name: 'Admin User', org: 'Kgotla Capital', status: 'active', mfa_enabled: false, created_at: new Date().toISOString() };
        localStorage.setItem('kc_user', JSON.stringify(demoUser));
        AppStore.currentUser = demoUser;
    }
})();
